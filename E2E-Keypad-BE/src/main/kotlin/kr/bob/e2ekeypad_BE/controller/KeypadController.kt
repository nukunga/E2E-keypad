...
class KeypadController(
    ...
    fun generateKeypad(): Map<String, Any> {
        ...
        val images = keypad.keyMappings.map { (hash, key) ->
        ...
        // 응답 JSON 형식으로 변환합니다.
        val encryptedKeys = keypad.keyMappings.mapValues { (_, key) ->
            RSAUtil.encrypt(publicKey, key)
        }

        val response = mapOf(
                "keys" to encryptedKeys.values.toList(),
